...
/***/ function(module, exports, __webpack_require__) {
	...
	var MyApp = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement(RectangleManager, {
					color: this.state.currentColor,
					onChange: this.handleChange
				}),
				_react2.default.createElement('br', null),
				_react2.default.createElement(Rectangle, { color: this.state.currentColor })
			);
		},
		getInitialState: function getInitialState() {
			return { currentColor: 'red' };
		},
		handleChange: function handleChange(newColor) {
	...
	var RectangleManager = _react2.default.createClass({
		displayName: 'RectangleManager',
		render: function render() {
			return _react2.default.createElement(
				'form',
				null,
	...
	_reactDom2.default.render(_react2.default.createElement(MyApp, null), document.getElementById('react-props'));
